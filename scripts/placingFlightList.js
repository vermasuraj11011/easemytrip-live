...
async function displayBook() {
	let url = new URL('https://flight-easemytrip.herokuapp.com/flight');
	...
	data.forEach((element) => {
		...
		function placing() {
			return `<div class="bookMain flexSpace">
		                ...
		                <button class="book flexCenter" onclick="getData(${element.id})" id="${element.id}"}>
		                    BOOK NOW
		                </button>
		            </div>`;
		}
...
// let btn = document.querySelectorAll('.book');
// console.log('btn:', btn)
...
async function getData(e) {
	let urls = new URL('https://flight-easemytrip.herokuapp.com/flight');
