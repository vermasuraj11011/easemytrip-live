...
document.getElementById('flightRoute').innerHTML = `${bookedTicket[0].source}-${bookedTicket[0].destination}`;

document.getElementById('departDate').innerHTML = bookedTicket[0].journey_date;

document.getElementById('Carrier').innerHTML = bookedTicket[0].airline_name;

document.getElementById('departTime').innerText = bookedTicket[0].takeoff_time;

document.getElementById('duration').innerHTML = `${timeDiff()}`;

document.getElementById('landingDate').innerText = bookedTicket[0].landing_time;

document.getElementById('aircraftName').innerHTML = `${bookedTicket[0].aircraft_code} - ${bookedTicket[0]
	.aircraft_number}`;

document.getElementById('source').innerText = bookedTicket[0].source;

document.getElementById('destination').innerText = bookedTicket[0].destination;
...
document.getElementById('price').innerHTML = `&#8377  ${bookedTicket[0].price} `;

var payAmount = bookedTicket[0].price + 779;
